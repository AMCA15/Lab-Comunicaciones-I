...
C1 = 0;			% número de carnet del integrante 1 (cinco digitos)
C2 = 0;			% número de carnet del integrante 2 (cinco digitos)
...
switch tipo_codigo
    ...
    case {'a', 'A'}
        ...
        fuente = {'00' '01' '10' '11'}; 	% contiene 2^LH strings con todas las palabras binarias de LH bits
        codigo = {'0' '11' '101' '100'}; 	% mapeo del Codigo Huffman
