classdef ModulationModel < handle
    ...
    methods (Hidden)
        function PrintPwrMsgs(obj, power_msg, power_msg_mod)
            disp("======================================");
        ...
        function PrintPwrSignalNoise(obj, title, power_signal, power_noise)
        ...
        function plot_labels_time(obj, SignalsName)
        ...
        function plot_labels_frecuency(obj, SignalsName)
